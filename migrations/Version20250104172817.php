 ...
 */
final class Version20250104172817 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE room (id INT AUTO_INCREMENT NOT NULL, id_city_id INT NOT NULL, format_id INT NOT NULL, type_seats_id INT NOT NULL, title VARCHAR(255) NOT NULL, number_seats INT NOT NULL, date_add DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', INDEX IDX_729F519B5531CBDF (id_city_id), INDEX IDX_729F519BD629F605 (format_id), INDEX IDX_729F519B7CFC8404 (type_seats_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
