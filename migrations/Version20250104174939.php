...
final class Version20250104174939 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS film_genre_film (film_genre_id INT NOT NULL, film_id INT NOT NULL, INDEX IDX_864DCA9AE0111C76 (film_genre_id), INDEX IDX_864DCA9A567F5183 (film_id), PRIMARY KEY(film_genre_id, film_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
